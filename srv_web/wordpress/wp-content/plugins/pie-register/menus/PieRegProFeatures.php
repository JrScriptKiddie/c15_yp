        	...
        	<?php if( $action == 'addons' ) { ?> 
                ...
                <div class="addons-container-section">
                    <div class="addon-row">
                        ...
                        <div class="addon-column margin-right">
                            <div class="addon-container">
                                <img class="addon-img" src="<?php echo plugins_url("assets/images/pro/11.jpg", dirname(__FILE__) ); ?>" alt="bbPress Addon">
                                <div class="">
                                    <div class="addon-content-container">
                                        <h3>bbPress Addon</h3>
                ...
                <div class="features-main-container">
                    <div class="et_pb_row et_pb_row_1 features-row">
                        <div class="feature-single-container margin-right">
                            <div class="feature-icon-container" style="background-image: url('<?php echo plugins_url("assets/images/pro/feature-1.png", dirname(__FILE__) ); ?>')"></div>
                            <a class="" href="">
                        ...
                        <div class="feature-single-container margin-right">
                            <div class="feature-icon-container" style="background-image: url(<?php echo plugins_url("assets/images/pro/block-users.png", dirname(__FILE__) ); ?>)"></div>
                            <a class="" href="">
                                <div class="feature-content-container">
                                    <h5>User Control</h5>
                        ...
                        <div class="feature-single-container margin-right">
                            <div class="feature-icon-container" style="background-image: url(<?php echo plugins_url("assets/images/pro/role-based-redirection.png", dirname(__FILE__) ); ?>)"></div>
                            <a class="" href="">
                                <div class="feature-content-container">
                        ...
                        <div class="feature-single-container margin-right">
                            <div class="feature-icon-container" style="background-image: url(<?php echo plugins_url("assets/images/pro/auto-login.png", dirname(__FILE__) ); ?>)"></div>
                            <a class="" href="">
                                <div class="feature-content-container">
                                    <h5>Auto Login</h5>
                        ...
                        <div class="feature-single-container margin-right">
                            <div class="feature-icon-container" style="background-image: url(<?php echo plugins_url("assets/images/pro/built-in-forms.png", dirname(__FILE__) ); ?>)"></div>
                            <a class="" href="">
                                <div class="feature-content-container">
                        ...
                        <div class="feature-single-container margin-right">
                            <div class="feature-icon-container" style="background-image: url(<?php echo plugins_url("assets/images/pro/login-security.png", dirname(__FILE__) ); ?>)"></div>
                            <a class="" href="">
                                <div class="feature-content-container">
                        ...
                        <div class="feature-single-container margin-right">
                            <div class="feature-icon-container" style="background-image: url(<?php echo plugins_url("assets/images/pro/content-restriction.png", dirname(__FILE__) ); ?>)"></div>
                            <a class="" href="">
                                <div class="feature-content-container">
                        ...
                        <div class="feature-single-container margin-right">
                            <div class="feature-icon-container" style="background-image: url(<?php echo plugins_url("assets/images/pro/timed-form-submission.png", dirname(__FILE__) ); ?>)"></div>
                            <a class="" href="">
                                <div class="feature-content-container">
                        ...
                        <div class="feature-single-container margin-right">
                            <div class="feature-icon-container" style="background-image: url(<?php echo plugins_url("assets/images/pro/restrict-widgets.png", dirname(__FILE__) ); ?>)"></div>
                            <a class="" href="">
                                <div class="feature-content-container">
                        ...
                        <div class="feature-single-container margin-right">
                            <div class="feature-icon-container" style="background-image: url(<?php echo plugins_url("assets/images/pro/importnexport.png", dirname(__FILE__) ); ?>)"></div>
                            <a class="" href="">
                                <div class="feature-content-container">
                        ...
                        <div class="feature-single-container margin-right">
                            <div class="feature-icon-container" style="background-image: url(<?php echo plugins_url("assets/images/pro/ticket-support.png", dirname(__FILE__) ); ?>)"></div>
                            <a class="" href="">
                                <div class="feature-content-container">
                        ...
                        <div class="feature-single-container margin-right">
                            <div class="feature-icon-container" style="background-image: url(<?php echo plugins_url("assets/images/pro/user-roles.png", dirname(__FILE__) ); ?>)"></div>
                            <a class="" href="">
                                <div class="feature-content-container">
                                    <h5>User Roles</h5>
                        ...
                        <div class="feature-single-container margin-right">
                            <div class="feature-icon-container" style="background-image: url(<?php echo plugins_url("assets/images/pro/file-upload.png", dirname(__FILE__) ); ?>)"></div>
                            <a class="" href="">
                                <div class="feature-content-container">
                                    <h5>File Upload</h5>
                        ...
                        <div class="feature-single-container margin-right">
                            <div class="feature-icon-container" style="background-image: url(<?php echo plugins_url("assets/images/pro/invitation-only.png", dirname(__FILE__) ); ?>)"></div>
                            <a class="" href="">
                                <div class="feature-content-container">
