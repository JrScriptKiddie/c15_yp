...
<?php if( (isset($_GET['tab']) && $_GET['tab'] == 'ux') && (isset($_GET['subtab']) && $_GET['subtab'] == 'advanced')) { ?>
        <?php
          ...
          $_available_in_pro 	= ' - <span style="color:red;font-size:14px;">'. __("Available in premium version","pie-register") . '</span>';
			  ?>
        <h3><?php echo __("Pie Register Theme",'pie-register') . $_available_in_pro ?></h3>
        <div class="fields">
        	<div class="flt_lft width_full">
            <label for="piereg_pr_theme"><?php _e("Select Theme",'pie-register') ?></label>
            <select <?php echo $_disable; ?> name="pr_theme" id="piereg_pr_theme">
        ...
        <div class="fields fields_submitbtn">
            ...
            <input <?php echo $_disable; ?> type="submit" class="submit_btn" value="<?php _e("Save Settings","pie-register"); ?>" />
        </div>        
<?php } else { ?>	
    ...
    <div class="fields">
        ...
        <input id="pie_custom_logo_url" type="text" name="custom_logo_url" value="<?php echo $piereg['custom_logo_url'];?>" placeholder="<?php _e("Please enter Logo URL","pie-register"); ?>" class="input_fields" />
    ...
    <div class="fields">
        ...
        <input type="text" name="custom_logo_tooltip" class="input_fields" id="custom_logo_title" value="<?php echo $piereg['custom_logo_tooltip'];?>" placeholder="<?php _e("Enter logo tooltip text","pie-register"); ?>" />
    ...
    <?php if ( $piereg['custom_logo_url'] ) {?>
        <div class="fields">
            ...
            <img class="mar_as_allinputs" src="<?php echo $piereg['custom_logo_url'];?>" alt="<?php _e( 'Custom Logo', 'pie-register' ); ?>" />
        </div>
        <div class="fields">
