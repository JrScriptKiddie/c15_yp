	...
	<div class="settings">
		...
		?>
				...
				if( $coming_soon_aweber ) { ?>
                    <div id="piereg_aweber"><div class="right_section image_wrapper"><img class="comming_soon_img" alt="Aweber Coming Soon" src="<?php echo PIEREG_PLUGIN_URL.'assets/images/Coming-soon_aweber.png'; ?>" /></div></div>    
                <?php } ?>
	</div>
</div>
</div>