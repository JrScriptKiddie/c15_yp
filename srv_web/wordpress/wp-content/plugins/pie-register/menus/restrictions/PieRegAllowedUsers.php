              ...
              <form method="post" action="#piereg_block_by_username">
                ...
                <div class="fields">
                  <div class="radio_fields">
                    <input <?php echo $_disable; ?> id="enable_allowedusername" type="checkbox" name="enable_allowedusername" value="1" <?php echo (isset($piereg['enable_allowedusername']) && $piereg['enable_allowedusername']=="1")?'checked="checked"':''?>>
                  </div>
                ...
                <div class="fields">
                  ...
                  <textarea <?php echo $_disable; ?> id="piereg_ald_username" name="piereg_ald_username"><?php echo isset($piereg['piereg_ald_username']) ? $piereg['piereg_ald_username'] : ""; ?></textarea>
          ...
          <div class="">
            <div class="pie-register-blocked-users">
              <form method="post" action="#piereg_block_by_email">
                ...
                <div class="fields">
                  <div class="radio_fields">
                    <input <?php echo $_disable; ?> id="enable_allowedemail" type="checkbox" name="enable_allowedemail" value="1" <?php echo (isset($piereg['enable_allowedemail']) && $piereg['enable_allowedemail']=="1")?'checked="checked"':''?>>
                  </div>
                ...
                <div class="fields">
                  ...
                  <textarea <?php echo $_disable; ?> id="piereg_ald_email" name="piereg_ald_email"><?php echo isset($piereg['piereg_ald_email']) ? $piereg['piereg_ald_email'] : ""; ?></textarea>
                  <div class="note_parent width_full flt_lft">
                    <div class="note"> <strong>
                      <?php _e("Note","pie-register");?>
                      :</strong>
