    ...
    <div id="piereg_paypal_payment_gateway">
        <div id="container">
          <div class="right_section">
            <div class="settings">
              <?php echo '<a href="http://www.paypal.com/payments-standard" target="_blank"><img class="logo-payment-align" src="'.$this->plugin_url."/assets/images/paypal-standard-logo.png".'" /></a>'; ?>
              <div id="pie-register">
                ...
                <div class="fields">
                  ...
                  <select name="piereg_paypal_sandbox" id="paypal_sandbox">
                    <option <?php echo ($paypal_live) ? 'selected="selected"' : "";?> value="no"><?php _e('Live', 'pie-register');?></option>
                    <option <?php echo ($paypal_sandbox) ? 'selected="selected"' : "";?> value="yes"><?php _e('Sandbox', 'pie-register');?></option>
                  </select>
                </div>
                    ...
                    <div id="pie-register">
                       <form method="post" action="#piereg_general_settings_payment_gateway">
                            ...
                            <div class="fields">
                                ...
                                <input type="text" class="input_fields" name="payment_success_msg" id="payment_success_msg" value="<?php echo ((isset($piereg['payment_success_msg']) && !empty($piereg['payment_success_msg']))?$piereg['payment_success_msg']:__("Payment was successful.","pie-register"));?>" />
                            </div>
                            <!--	Payment Failed Message	-->
                            <div class="fields">
                                <label for="payment_faild_msg"><?php _e('Payment Failed', 'pie-register');?></label>
                                <input type="text" class="input_fields" name="payment_faild_msg" id="payment_faild_msg" value="<?php echo ((isset($piereg['payment_faild_msg']) && !empty($piereg['payment_faild_msg']))?$piereg['payment_faild_msg']:__("Payment failed.","pie-register"));?>" />
                            </div>
                            <!--	Renew Account Message	-->
                            <div class="fields">
                                <label for="payment_renew_msg"><?php _e('Reactivate Account', 'pie-register');?></label>
                                <input type="text" class="input_fields" name="payment_renew_msg" id="payment_renew_msg" value="<?php echo ((isset($piereg['payment_renew_msg']) && !empty($piereg['payment_renew_msg']))?$piereg['payment_renew_msg']:__("Account needs to be activated.","pie-register"));?>" />
                            </div>
                            <!--	Alreact Activate Message	-->
                            <div class="fields">
                                <label for="payment_already_activate_msg"><?php _e('Already Active', 'pie-register');?></label>
                                <input type="text" class="input_fields" name="payment_already_activate_msg" id="payment_already_activate_msg" value="<?php echo ((isset($piereg['payment_already_activate_msg']) && !empty($piereg['payment_already_activate_msg']))?$piereg['payment_already_activate_msg']:__("Account is already active.","pie-register"));?>" />
                            </div>
