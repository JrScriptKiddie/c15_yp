...
## Доступ в портал
- Откройте `http://srv_wg_portal.localhostdevelopment.ag:8888/` (или URL портала в вашей сети).
...
- В разделе Users проверьте наличие пользователя (централизованные пользователи создаются автоматически). При отсутствии нужного пользователя пользователя необходимо создать либо в [LDAP](http://srv_ldap_mgmt.localhostdevelopment.ag/), либо прямо на WireGuard Portal (локальный пользователь).
